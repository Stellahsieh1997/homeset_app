...
<body class="font" style="background-color: #f0f0f0">
    <div class="container-fluid">
        ...
        <div class="row flex ">
            <svg class="w3-animate-fading" id="圖層_1" data-name="圖層 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 595.28 595.28">
                <defs>
                    <style>
                        .cls-1 {
                            fill: #254f6e;
                        ...
                        .cls-3 {
                            font-size: 60px;
                            font-family: Microsoft JhengHei, Tw Cen MT Condensed Extra Bold;
                            font-weight: 200;
                        }
                    </style>
                </defs>
                ...
                <text class="cls-3" transform="translate(136.77 481.32) scale(1.43 1)">Homeset</text>
            </svg>
            <hr>
    ...
    <div class="container-fluid bordertype col-md-8 offset-md-2 col-lg-6 offset-lg-3">

        <div class="container px-lg-5 " style="margin-top:10px;">
            <div class="row mx-lg-n5">
                <div class="col ">
                    <button class="btn buttontype tablink" onclick="openCity(event,'register')"> 註冊</button>
                </div>
                <!-- <div class="col ">
                    <button  class="btn buttontype tablink" onclick="openCity(event,'login')"> 登入</button>
                </div> -->
            </div>
        </div>

        <!-- <div class="w3-bar w3-white" style="justify-content: center">
            <button class="w3-bar-item w3-button tablink w3-blue" onclick="openCity(event,'register')">註冊</button>
            <button class="w3-bar-item w3-button tablink" onclick="openCity(event,'login')">登入</button>
          </div> -->
          ...
          <div id="register" class="w3-container  city">
            <form>
                ...
                <div class="form-group">
                    ...
                    <input type="password" class="form-control" id="exampleInputPassword1" placeholder="輸入密碼">
                ...
                <div class="form-group">
                    ...
                    <input type="password" class="form-control" id="exampleInputPassword1" placeholder="確認密碼">
                
                </div>
                <button type="submit" class="btn  w3-blue-grey" >確定</button>
            </form>
          </div>
    ...
    <script>
        function openCity(evt, cityName) {
          ...
          for (i = 0; i < x.length; i++) {
            tablinks[i].className = tablinks[i].className.replace(" w3-NavyPeony", "");
          }
          document.getElementById(cityName).style.display = "block";
          evt.currentTarget.className += " w3-NavyPeony";
        }
        </script>
